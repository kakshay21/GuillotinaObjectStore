...
class TransactionStub(object):
  ...
  def __init__(self, channel):
    ...
    self.SaveDublinCore = channel.unary_unary(
        '/gos.Transaction/SaveDublinCore',
        request_serializer=transaction__pb2.DublinCore.SerializeToString,
        response_deserializer=transaction__pb2.TxnId.FromString,
        )
...
class TransactionServicer(object):
  ...
  def SaveDublinCore(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_TransactionServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'SaveDublinCore': grpc.unary_unary_rpc_method_handler(
          servicer.SaveDublinCore,
          request_deserializer=transaction__pb2.DublinCore.FromString,
          response_serializer=transaction__pb2.TxnId.SerializeToString,
      ),
  }
